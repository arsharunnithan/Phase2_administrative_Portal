...
import com.simpliLearn.Classes.Subject;
import com.simpliLearn.Classes.Teacher;
import com.simpliLearn.Classes.Class;
import com.simpliLearn.Classes.Student;

/**
 * Servlet implementation class AdminControlServlet
 */
@WebServlet("/AdminControlServlet")
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (!getCookies(request, response) && (!command.equals("LOGIN"))) {
				...
				response.sendRedirect("/Phase2_AdministrativePortal/src/main/webapp/login.jsp");
			}
